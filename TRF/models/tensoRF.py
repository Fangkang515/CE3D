...
class TensorVMSplit(TensorBase):
    ...
    def get_optparam_groups(self, lr_finetune_density, lr_init_spatialxyz = 0.02, lr_init_network = 0.001):
        # grad_vars = [{'params': self.density_line, 'lr': lr_init_spatialxyz}, {'params': self.density_plane, 'lr': lr_init_spatialxyz},
        grad_vars = [{'params': self.density_line, 'lr': lr_finetune_density}, {'params': self.density_plane, 'lr': lr_finetune_density},
