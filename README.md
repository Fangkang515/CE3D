...
### :star2: :star2: **Update** We release a new powerful :heart: CE3D++ :heart: framework, which leverages an LLM to integrate dozens of different models to enable various 3D and 4D scene editing during chatting :star2: :star2:
