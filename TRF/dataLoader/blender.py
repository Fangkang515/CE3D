...
class BlenderDataset(Dataset):
    ...
    def read_meta(self):
        ...
        for i in tqdm(
            ...
            if self.split == "train" and self.args.edit_name:
                img_name = frame["file_path"].replace("train", self.args.edit_name)
                image_path = os.path.join(self.root_dir, f"{img_name}.png")
            else:
